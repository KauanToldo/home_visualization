looker.plugins.visualizations.add({
    ...
    updateAsync: function(data, element, config, queryResponse, details, done) {
        ...
        <body style="margin: 0; padding: 0; box-sizing: border-box;">
            ...
            <div style="position: relative; z-index: 5; width: 100%; min-height: 100vh; font-family: 'Montserrat', sans-serif; display: flex; justify-content: center; align-items: center;
                background-image: url(https://storage.googleapis.com/looker_styles_servopa/imagens/fundo_servopa.png);
                background-position: center;
                background-size: cover;
                background-repeat: no-repeat;">
