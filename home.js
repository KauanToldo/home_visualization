      ...
      this._tableContainer.innerHTML = `
        ...
        background-repeat: no-repeat;">
            ...
            <div style="text-align: center;">
                ...
                <div class="card" id="card1" style="cursor: pointer; background-color: #ffffff; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); border-radius: 12px; width: 350px; overflow: hidden;">
                ...
                <div class="card" id="card2" style="cursor: pointer; background-color: #ffffff; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); border-radius: 12px; width: 350px; overflow: hidden;">
                ...
                <div class="card" id="card3" style="cursor: pointer; background-color: #ffffff; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); border-radius: 12px; width: 350px; overflow: hidden;">
